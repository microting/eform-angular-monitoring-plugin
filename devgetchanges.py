...
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-monitoring-plugin")

# Remove and copy main directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "monitoring-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "monitoring-pn")),
    (os.path.join("eFormAPI", "Plugins", "Monitoring.Pn"),
     os.path.join("eFormAPI", "Plugins", "Monitoring.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "monitoring-settings"),
    os.path.join("eform-client", "e2e", "Tests", "monitoring-general"),
    os.path.join("eform-client", "e2e", "Page objects", "Monitoring"),
